...
namespace Payments.Util.ParameterBuilders.Impl
{
    /// <summary>
    /// Url参数生成器
    /// </summary>
    public class UrlParameterBuilder
    {
        ...
        /// 初始化Url参数生成器
        /// </summary>
        public UrlParameterBuilder(HttpRequest httpRequest = null) : this("", httpRequest)
        {
        }
        ...
        public UrlParameterBuilder(ParameterBuilder builder, HttpRequest httpRequest = null)
        {
        ...
        public UrlParameterBuilder(UrlParameterBuilder builder, HttpRequest httpRequest = null) : this("", httpRequest, builder)
        {
        }
        ...
        /// <param name="builder">Url参数生成器</param>
        public UrlParameterBuilder(string url, HttpRequest httpRequest, UrlParameterBuilder builder = null)
        {
            Request = httpRequest;
