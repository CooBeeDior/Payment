...
namespace Payments.Alipay.Parameters
{
    ...
    public class AlipayParameterBuilder
    {
        ...
        public void Init()
        {
            Format("json").Charset(Config.Charset).SignType("RSA2").Timestamp().Version("1.0").AppId(Config.AppId).NotifyUrl(Config.NotifyUrl);
        }
        /// <summary>
        /// 添加
        /// </summary>
        ...
        public AlipayParameterBuilder Add(string key, string value)
        {
            ...
            if (_builder.GetValue(key) == null) return this;
            _builder.Remove(key);
        ...
        /// <param name="key">键</param>
        /// <returns></returns>
        public AlipayParameterBuilder Remove(string key)
        {
            if (key.IsEmpty()) return this; 
            if (_builder.GetValue(key) == null) return this;
            _builder.Remove(key);        
